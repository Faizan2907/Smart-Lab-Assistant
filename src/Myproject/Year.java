...
public class Year extends javax.swing.JFrame {
    ...
    public Year() {
        ...
        ResultSet rs5=st.executeQuery("select year from stud_info");
        while(rs5.next())
        {
            jComboBox1.addItem(rs5.getString("year"));
        }
            ResultSet rs=st.executeQuery("select * from stud_info where year="+jComboBox1.getSelectedItem());
